...
Automatically generates categorized, beautifully formatted changelog entries from merged PR diffs — powered by Claude or GPT.
...
| `model_name` | ❌ | Auto | `claude-sonnet-4-20250514` (Anthropic) or `gpt-4o` (OpenAI) |
